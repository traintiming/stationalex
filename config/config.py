...
OWNER_ID = list(map(int, getenv("OWNER_ID", "6180148187").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/tamil_anexpress_chat")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/traintiming/stationalex")
